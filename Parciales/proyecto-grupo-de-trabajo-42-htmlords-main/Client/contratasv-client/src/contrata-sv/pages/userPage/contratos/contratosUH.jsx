                ...
                <div className="flex flex-col justify-center items-center h-auto">
                    <div className="bg-white rounded-lg shadow-lg p-8 m-4">
                        <div className="flex justify-between items-center">
                            <Link to="/userPage/contratos/activas" className="py-2 px-4 rounded bg-white hover:bg-gray-500 text-black font-bold">
                                Activas
                            </Link>
                            <Link to="/userPage/contratos/historial" className="py-2 px-4 rounded bg-green-700 hover:bg-green-900 text-white font-bold">
                                Historial
                            </Link>
