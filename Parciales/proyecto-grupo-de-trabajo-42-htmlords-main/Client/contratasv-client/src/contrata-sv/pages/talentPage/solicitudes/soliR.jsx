            ...
            <article className="flex flex-col justify-center items-center snap-y h-screen w-screen overflow-scroll">
                <div className="bg-white rounded-lg shadow-lg p-4 m-4">
                    <div className="flex justify-between items-center">
                        <Link to="/talentPage/solicitudes/pendientes" className="py-2 px-4 rounded bg-white hover:bg-gray-500 text-black font-bold">
                            Pendientes
                        </Link>
                        <Link to="/talentPage/solicitudes/rechazadas" className="py-2 px-4 rounded bg-green-700 hover:bg-green-900 text-white font-bold ">
                            Rechazadas
                        </Link>
